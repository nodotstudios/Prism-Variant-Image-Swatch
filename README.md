# Prism Variant Image & Swatch — Shopify App

Production-ready Shopify App for assigning multiple product media items (images, Shopify-hosted videos, external videos, and 3D models) to visual variant combinations (e.g., *Black + Leather*, *Navy + Canvas*).

On the storefront, changing visual variant options filters main slides and thumbnails without affecting non-visual options (such as *Size*), pricing, or checkout.
...
- **Multi-Option Mapping**: Group multiple variants into a single visual gallery group to avoid duplicating media uploads.
